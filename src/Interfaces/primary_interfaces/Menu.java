...
import Interfaces.secondary_interfaces.Salva;
import Interfaces.secondary_interfaces.Rules;
import Interfaces.secondary_interfaces.Classifica;
import Interfaces.secondary_interfaces.About;
...
//creazione del menu
    public Menu(){
        ...
        JMenu visualizza = new JMenu("Visualizza");
            ...
            JMenuItem statistics = new JMenuItem("Statistiche");
        visualizza.add(rules);     
        visualizza.add(classifica);
        //visualizza.add(statistics);
...
//eventi per ogni voce del menu        
        ...
        class computer implements ActionListener, Serializable{
            public void actionPerformed (ActionEvent e){
                mode = 0;
                Main.frame.setVisible(false);
                    Main.createGame(Game.size, Game.n_card);
                p.getTPlayer1().setVisible(true);
                p.getPPlayer1().setVisible(true);
